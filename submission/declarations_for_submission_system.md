# Declarations for submission system
...
This study used previously generated public or access-controlled datasets and summary statistics. No new human participants were recruited, no intervention was performed, and no identifiable participant-level data were collected for this study. Ethics approval and informed consent for the original datasets were handled by the original studies where applicable.
...
Processed source data, figure source data, analysis outputs and custom code required to reproduce the reported summaries are available in the project repository. Original public datasets and GWAS summary statistics remain available from their original repositories or study sources under the corresponding access terms. Controlled-access, license-restricted or source-term-restricted resources, including restricted GWAS summary statistics where applicable and GTEx-derived resources subject to source terms, are not redistributed in this repository. Access to those resources should be requested from the original data providers.
